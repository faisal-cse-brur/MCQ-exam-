...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">{{ Auth::user()->name }}
</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-close">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('addSubject')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Subject</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('addExam')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Exam</p>
                </a>
              </li>
              <li class="nav-item">
                ...
                <li class="nav-item">
                <a href="{{route('showreviewexam')}}" class="nav-link">
              ...
              <li class="nav-item">
                <a href="{{route('routine')}}" class="nav-link">
                  <i class="fas fa-tasks"></i>
                  <p>Routine</p>
                </a>
              </li>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2022-2023 <a href="#"></a>by Faisal Ahmad</strong>
    All rights reserved.
  </footer>
